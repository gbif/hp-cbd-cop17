...
[![Build Status](https://builds.gbif.org/job/hp-cbd-cop17/badge/icon)](https://builds.gbif.org/job/hp-cbd-cop17/lastBuild/console)
...
# GBIF Hosted Portal: cbd-cop17

This Jekyll website, **[cbd-cop17 (Staging)](https://cbd-cop17.hp.gbif-staging.org/)**, makes use of a theme and biodiversity widgets developed by the GBIF network.
